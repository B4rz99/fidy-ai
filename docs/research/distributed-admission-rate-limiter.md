...
| PATPairing start log + live-state count                                                           | T     | Domain-separated HMAC of authoritative anonymous source under the pat-pairing-start purpose; 5/min and 10/10min rolling windows, 10,000 live pending/approved pairings. Counter insertion and unique pairing insertion are one commit. Selected two-process proof below.                                                                                                                  | `shell/tokens/pat-pairing.ts:150-184`, `shell/db/migrations/0035-pat-pairings.ts:147-194`                                                                                                                                                                |
