    ...
    it.effect("classifies every canonical operation as a query or mutation", () =>
      Effect.gen(function* () {
        const expected = {
          ...
          "recovery.rotateBackupRecoveryCode": "mutation",
          "pats.listPATs": "query",
          "pats.revokePAT": "mutation",
          "pats.revokeAllPATs": "mutation",
          ...
          "transactions.linkTransactions": "mutation",
          "transactions.unlinkTransactions": "mutation",
          ...
          "emailAuthentication.requestEmailReplacement": "mutation",
          "subscription.getUpgradeUrl": "query",
          "subscription.listSubscriptionOffers": "query",
          "ingestion.enableEmailForwarding": "mutation",
          "ingestion.getEmailForwarding": "query",
    ...
    it.effect("assigns explicit hosted-agent confirmation policy to every operation", () =>
      Effect.gen(function* () {
        const expected = {
          ...
          "recovery.rotateBackupRecoveryCode": "not-required",
          "pats.listPATs": "not-required",
          "pats.revokePAT": "required",
          "pats.revokeAllPATs": "required",
          ...
          "transactions.linkTransactions": "not-required",
          "transactions.unlinkTransactions": "not-required",
          ...
          "emailAuthentication.requestEmailReplacement": "required",
          "subscription.getUpgradeUrl": "not-required",
          "subscription.listSubscriptionOffers": "not-required",
          "ingestion.enableEmailForwarding": "not-required",
          "ingestion.getEmailForwarding": "not-required",
