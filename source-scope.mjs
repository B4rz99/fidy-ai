...
// through its built-command and production-image seams because subprocess coverage cannot observe
// it. Their decoded configuration and artifacts remain measured by those behavioural checks.
//
