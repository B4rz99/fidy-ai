...
export const recordBrowserCategoryWork = Function.dual<
  (id: string, current: number) => (subject: BrowserCategorySubject) => OwnedStatement,
  (subject: BrowserCategorySubject, id: string, current: number) => OwnedStatement
>(3, (subject, id, current) => {
