...
export const TelemetryRegistry = {
  ...
  operation: [
    ...
    "observability.deploymentSmokeIngress",
    "observability.deploymentSmokePublish",
    "observability.deploymentSmokeProcess",
    "observability.deploymentSmokeAgent",
    "observability.deploymentSmokeModel",
    "observability.deploymentSmokeProvider",
    "observability.deploymentSmokeDefect",
    "observability.deploymentSmokeExpectedOutcome",
  ],
  ...
  error: [
    ...
    "deployment_smoke_defect",
    "deployment_smoke_expected_outcome",
  ],
