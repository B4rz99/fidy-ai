...
and Workflow history. Forwarded-email ingress and private retention are installed; its downstream
processing and the full hosted-Turn path still require their own adapters and platform evidence.
