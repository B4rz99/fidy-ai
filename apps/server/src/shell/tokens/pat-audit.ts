...
export const recordSessionPATTransition = Function.dual<
  (input: TransitionInput) => (session: FreshSessionSubject) => OwnedStatement,
  (session: FreshSessionSubject, input: TransitionInput) => OwnedStatement
>(2, (session, input) =>
...
export const recordPATList = Function.dual<
  (input: AuditTime) => (session: FreshSessionSubject) => OwnedStatement,
  (session: FreshSessionSubject, input: AuditTime) => OwnedStatement
>(2, (session, input) => ({
  sql: `INSERT INTO pat_audit (id,user_id,session_id,operation,outcome,occurred_at_ms)
...
export const recordOnePATRevocation = Function.dual<
  (input: RevokeAuditInput) => (session: FreshSessionSubject) => OwnedStatement,
  (session: FreshSessionSubject, input: RevokeAuditInput) => OwnedStatement
>(2, (session, input) => ({
  sql: `INSERT INTO pat_audit (id,user_id,session_id,pat_id,operation,outcome,occurred_at_ms)
...
export const recordAllPATRevocations = Function.dual<
  (input: AuditTime) => (session: FreshSessionSubject) => OwnedStatement,
  (session: FreshSessionSubject, input: AuditTime) => OwnedStatement
>(2, (session, input) => ({
  sql: `INSERT INTO pat_audit (id,user_id,session_id,operation,outcome,occurred_at_ms)
...
export const recordCanonicalPATWork = Function.dual<
  (input: CanonicalAuditInput) => (subject: PATSubject) => OwnedStatement,
  (subject: PATSubject, input: CanonicalAuditInput) => OwnedStatement
>(2, (subject, input) => {
