...
import {
  type ApiClient,
  TestWompiBillingClient,
  TestWompiEnrollmentClient,
  makeApiClientLive,
} from "./api-harness";
...
>()("@fidy/server/shell/testing/whatsapp-acceptance-harness/WhatsAppAcceptanceKapsoControl") {}
...
const acceptanceProbeCredentials: AcceptanceProbeCredentials = {
  "WA-A04": {
    ...
    tag: Context.Service<ApiClient>(
      "@fidy/server/shell/testing/whatsapp-acceptance-harness/WhatsAppAcceptanceA04ApiClient"
    ),
  },
  "WA-A05": {
    ...
    tag: Context.Service<ApiClient>(
      "@fidy/server/shell/testing/whatsapp-acceptance-harness/WhatsAppAcceptanceA05ApiClient"
    ),
  },
  "WA-A06": {
...
>()("@fidy/server/shell/testing/whatsapp-acceptance-harness/WhatsAppAcceptanceCallerControl") {}
...
>()("@fidy/server/shell/testing/whatsapp-acceptance-harness/WhatsAppAcceptanceModelControl") {}
