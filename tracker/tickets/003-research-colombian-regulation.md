...
2. **Financial licensing**: does a PFM that only *reads* financial data (no money movement, no custody) need any Superintendencia Financiera license or registration? Where is the line?
